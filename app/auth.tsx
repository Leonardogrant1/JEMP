...
export default function AuthScreen() {
    ...
    function handleEmailPress() {
        ...
        translateY.value = withTiming(600, { duration: 240 }, (finished) => {
            if (finished) {
                runOnJS(router.push)('/magic-link');
            }
        });
    }
...
function createStyles(theme: (typeof Colors)['dark']) {
    return StyleSheet.create({
        ...
        sheet: { backgroundColor: theme.surface, borderTopLeftRadius: 24, borderTopRightRadius: 24 },
        ...
        divider: { height: 1, backgroundColor: theme.borderDivider },
        body: { padding: 20, gap: 12 },
        appleBtn: { height: 56, backgroundColor: '#fff', borderRadius: 100, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10 },
        appleBtnText: { fontSize: 14, fontFamily: Fonts.satoshiBold, color: '#000', letterSpacing: 0.5 },
        socialBtn: { height: 56, borderRadius: 100, borderWidth: 1, borderColor: theme.borderStrong, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10 },
        legal: { fontSize: 12, fontFamily: Fonts.satoshiRegular, color: theme.textSubtle, textAlign: 'center', lineHeight: 18, paddingHorizontal: 32, paddingTop: 4 },
        legalLink: { fontFamily: Fonts.satoshiBold, color: theme.textMuted },
    });
}
