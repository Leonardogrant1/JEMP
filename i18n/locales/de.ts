...
const de: Record<TranslationKeys, string> = {
    ...
    'plan.schedule_subtitle': 'An welchen Tagen wirst du trainieren? Für jeden Tag wird eine Session erstellt. Mindestens 2.',
    'plan.schedule_duration_label': 'Trainingsdauer',
    'plan.schedule_notes_label': 'Verletzungen & Einschränkungen',
    'plan.schedule_notes_hint': 'Z.B. "Habe einen leichten Knieschaden — keine tiefen Kniebeugen." oder "Schulter ist gerade angespannt."',
