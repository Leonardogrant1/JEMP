...
import { preparePlanGeneration, runSessionPhasesCD, savePlan, sendPlanNotification, trackPlanGeneration, updateJobStatus } from './activities';
...
async function main() {
    ...
    const jempWorker = await Worker.create({
        ...
        activities: { updateJobStatus, preparePlanGeneration, runSessionPhasesCD, savePlan, sendPlanNotification, trackPlanGeneration },
