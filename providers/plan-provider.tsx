...
export type WorkoutSession = Pick<
    ...
    'id' | 'name' | 'description' | 'session_type' | 'scheduled_at' | 'original_scheduled_at' | 'status' | 'estimated_duration_minutes' | 'workout_plan_session_id' | 'rest_adjust_seconds'
> & { primary_exercise_slug?: string | null; primary_image_group?: string | null; focus_categories?: string[] };
...
> & { primary_exercise_slug?: string | null; primary_image_group?: string | null; mode_slug?: string | null; focus_categories?: string[] };
