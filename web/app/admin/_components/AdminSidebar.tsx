...
const TABS: Tab[] = [
  ...
  {
    id: 'session-thumbnails',
    label: 'Session-Bilder',
    href: '/admin/session-thumbnails',
    matchPrefix: '/admin/session-thumbnails',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    href: '/admin/plan-simulator',
    matchPrefix: '/admin/plan-simulator',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  function isActive(tab: Tab) {
    if (tab.id === 'exercises') {
      return pathname === '/admin' || (
        ...
        !pathname.startsWith('/admin/sports') &&
        !pathname.startsWith('/admin/session-thumbnails') &&
