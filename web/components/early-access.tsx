      ...
      <Reveal className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          <a
            ...
            className="inline-flex shrink-0 items-center gap-3 px-6 py-3 rounded-2xl bg-black/60 border border-white/15 backdrop-blur-sm text-white hover:bg-black/80 hover:border-brand-cyan/50 transition-colors shadow-lg shadow-black/30 w-full sm:w-auto justify-center"
          >
            ...
            <span className="flex flex-col items-start leading-tight whitespace-nowrap">
              <span className="text-xs text-white/60">{t("badgeAppStoreTop")}</span>
          ...
          >
            ...
            <span className="flex flex-col items-start leading-tight whitespace-nowrap">
              <span className="text-xs text-white/60">{t("badgePlayStoreTop")}</span>
