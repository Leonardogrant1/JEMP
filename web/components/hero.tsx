    ...
    >
      ...
      <div className="max-w-5xl mx-auto w-full flex flex-col sm:flex-row items-center gap-12 sm:gap-16">
        <div className="flex-1 text-left">
          ...
          <a
            href="#early-access"
            className="inline-block px-8 py-4 rounded-xl bg-brand-gradient font-bold text-white text-base hover:opacity-90 transition-opacity shadow-lg shadow-brand-cyan/20"
          >
            {t("cta")}
          </a>
        </div>
