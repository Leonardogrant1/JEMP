-- ─────────────────────────────────────────────────────────────────────────────
-- Fix: make universal exercises available in ALL environments
--
-- Background:
--   The original seed tagged bodyweight, band, dumbbell, medicine ball,
--   plyometric, conditioning, foam roller and mobility exercises as home-only.
--   This caused users with "gym" or "outdoor" environments to never see these
--   exercises in their pools.
--
-- Fix:
--   Add exercise_environments entries for ALL environments for these exercises,
--   so they show up regardless of which environment the user has selected.
--   Existing home entries remain; gym and outdoor entries are added.
--   Gym-only and outdoor-only exercises are untouched.
-- ─────────────────────────────────────────────────────────────────────────────
